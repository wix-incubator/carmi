...
- Nothing changes in place - you are defining a series of transformations, for example **assign** doesn't won't modify
  the input array it gets, it just generates a new object with the result
- **call** is your escape hatch - you can use it to do any transformation that is not part of the DSL, but don't modify
  the inputs or bugs will happen
