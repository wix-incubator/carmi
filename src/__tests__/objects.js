...
describe('testing objects', () => {
  describeCompilers(['simple', 'optimizing'], compiler => {
    ...
    describe('associate', () => {
      it('should associate with empty array', async () => {
        const initialData = { data: {a: 1}};
        const path = []
        const value = {}
        const model = {
          associate: root.get('data').associate(path, value),
        };
        const optModel = eval(await compile(model, { compiler }));

        const inst = optModel(initialData);
        expect(inst.associate).toEqual(_.set(initialData.data, path, value));
      });
      it('should associate with empty string', async () => {
        const initialData = { data: {a: 1}};
        const path = ''
        const value = {}
        const model = {
      ...
      it('should associate simple with array', async () => {
        const initialData = { data: {a: 1}};
        const path = ['b']
        const value = {}
        const model = {
      ...
      it('should associate simple with string', async () => {
        const initialData = { data: {a: 1}};
        const path = 'b'
        const value = {}
        const model = {
      ...
      it('should associate deep with array', async () => {
        const initialData = { data: {a: 1}};
        const path = ['a', 'b']
        const value = {}
        const model = {
      ...
      it('should associate deep with string', async () => {
        const initialData = { data: {a: 1}};
        const path = 'a.b'
        const value = {}
        const model = {
      ...
      it('should associate deep without destroying other properties with array', async () => {
      ...
      it('should associate deep without destroying other properties with string', async () => {
        const initialData = { data: {a: 1, b: {c: 'hey'}}};
        const path = 'a.b.z.d'
        const value = 'hello'
        const model = {
