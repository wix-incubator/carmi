...
const TokenTypeData = {
  ...
  gt: new TokenTypes({ chainIndex: 1, len: [3, 3], expectedType: 'number'}),
  lt: new TokenTypes({ chainIndex: 1, len: [3, 3], expectedType: 'number'}),
  gte: new TokenTypes({ chainIndex: 1, len: [3, 3], expectedType: 'number'}),
  lte: new TokenTypes({ chainIndex: 1, len: [3, 3], expectedType: 'number'}),
  plus: new TokenTypes({ chainIndex: 1, len: [3, 3] }),
  minus: new TokenTypes({ chainIndex: 1, len: [3, 3], expectedType: 'number'}),
  mult: new TokenTypes({ chainIndex: 1, len: [3, 3], expectedType: 'number'}),
  div: new TokenTypes({ chainIndex: 1, len: [3, 3], expectedType: 'number'}),
  mod: new TokenTypes({ chainIndex: 1, len: [3, 3], expectedType: 'number'}),
  ...
  startsWith: new TokenTypes({nonChained: true, chainIndex: 1, len: [3, 3], expectedType: 'string'}),
  endsWith: new TokenTypes({nonChained: true, chainIndex: 1, len: [3, 3], expectedType: 'string'}),
  toUpperCase: new TokenTypes({nonChained: true, chainIndex: 1, len: [2, 2], expectedType: 'string'}),
  toLowerCase: new TokenTypes({nonChained: true, chainIndex: 1, len: [2, 2], expectedType: 'string'}),
  floor: new TokenTypes({nonChained: true, chainIndex: 1, len: [2, 2], expectedType: 'number' }),
  ceil: new TokenTypes({nonChained: true, chainIndex: 1, len: [2, 2], expectedType: 'number' }),
  round: new TokenTypes({nonChained: true, chainIndex: 1, len: [2, 2], expectedType: 'number' }),
  parseInt: new TokenTypes({nonChained: true, chainIndex: 1, len: [2, 3], expectedType: 'string'}),
  substring: new TokenTypes({nonChained: true, chainIndex: 1, len: [4, 4], expectedType: 'string'}),
  split: new TokenTypes({nonChained: true, chainIndex: 1, len: [3, 3], expectedType: 'string'}),
